...
%TODO how to apply boosting in recommendation systems
...
% shortly describe other hybrid sections from burke and why are they not used in this thesis
...
It contains 663731 purchases, so it is only 0.06888\% dense, there are 56.37 purchases per user and 8.11 purchases per item. % TODO make table out of stats

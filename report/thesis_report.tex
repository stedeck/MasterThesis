...
There are different methods to calculate similarities between two vectors.
...
The logistic regression based matrix factorization algorithm \textit{LogRegSVD} (see algorithms \ref{alg:LogRegSVDTraining} and \ref{alg:LogRegSVDRecommendation}) was compared to the traditional SVD approach using linear regression and it was investigated for the impact of different parameters.

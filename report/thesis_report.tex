...
So the recommendations of different pairs of recommenders are analysed. %TODO add results to table and explain them

%todo add percentages to table (as second row in every cell)
\begin{table}
	\caption{}
	\label{tab:correlation}
	\begin{tabular}{|c|c||c|c|c|c|}
		\hline
		\textbf{Reco1}&\textbf{Reco2}&\textbf{both}&\textbf{only 1}&\textbf{only 2}&\textbf{none}\\ \hline
		\textit{CFItemNN}&\textit{CBNN (Categories)}&400&25446&1185&103812 \\ \hline

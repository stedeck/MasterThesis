...
This results into items that are purchased more often get a higher probability of being recommended.
...
So updates are performed by 

\begin{equation}
p_u = p_u + w_n \alpha d(u,i) (e_{ui} q_i + \lambda p_u)
\end{equation}

and 

\begin{equation}
q_i = q_i + w_n \alpha d(u,i) (e_{ui} p_u + \lambda q_i)
\end{equation}

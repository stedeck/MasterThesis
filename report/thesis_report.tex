...
For recommendation this leads to the following prediction rule to determine the score for a user-item-pair: %TODO see whether others used the same formula and add reference
